...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -27930.668704249925; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 12497.086122464412; // x position of the perpendicular encoder (in tick units)
    }
